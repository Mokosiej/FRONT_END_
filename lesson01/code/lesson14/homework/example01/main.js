...
let result = filterPlayersByLetter(players, 'A');
console.log(result);

function filterPlayersByLetter(playersArray, letter) {
    return playersArray.filter(player => player.name.startsWith(letter));
}
